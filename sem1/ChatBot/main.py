...
async def start(update: Update, context: CallbackContext) -> int:
    ...
    context.user_data['follow_up'] = False  # Flaga do śledzenia kontynuacji wątku
...
async def ask_question(update: Update, context: CallbackContext):
    context.user_data['follow_up'] = False  # Resetowanie flagi kontynuacji wątku
...
async def answer(update: Update, context: CallbackContext) -> int:
    ...
    # Analiza odpowiedzi tylko, jeśli to nie jest kontynuacja wątku
    ...
    if should_continue_topic(user_response, current_question):
        context.user_data['follow_up'] = True  # Ustawienie flagi kontynuacji wątku
